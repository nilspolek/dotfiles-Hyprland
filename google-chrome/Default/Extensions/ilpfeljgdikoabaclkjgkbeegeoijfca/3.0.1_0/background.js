...
(function (Actions) {
    ...
    Actions["READY"] = "ready";
    Actions["ENDED"] = "ended";
    Actions["TIME_UPDATE"] = "timeupdate";
})(Actions || (Actions = {}));
var States;
(function (States) {
...
var BackgroundMessageTypes;
(function (BackgroundMessageTypes) {
    BackgroundMessageTypes["REMOTE_UPDATE"] = "remote_update";
    BackgroundMessageTypes["ROOM_CONNECTION"] = "room_connection";
    BackgroundMessageTypes["SKIP_MARKS"] = "skip_marks";
})(BackgroundMessageTypes || (BackgroundMessageTypes = {}));
var WebpageMessageTypes;
(function (WebpageMessageTypes) {
    WebpageMessageTypes["LOCAL_UPDATE"] = "local_update";
    WebpageMessageTypes["ROOM_CONNECTION"] = "room_connection";
    WebpageMessageTypes["CONNECTION"] = "connection";
})(WebpageMessageTypes || (WebpageMessageTypes = {}));
function log(...args) {
    const date = DISPLAY_DEBUG_TIME ? [new Date().toJSON()] : [];
...
function getParameterByName(url, name = "rollTogetherRoom") {
    ...
    if (lodash_default().isNull(results) || results.length < 2) {
        return null;
    }
...
function getBackgroundWindow() {
    var _a;
    return (_a = chrome.extension.getBackgroundPage()) === null || _a === void 0 ? void 0 : _a.window;
}
...
const serverUrl = "https://rt-sync.azurewebsites.net";
const background_window = __webpack_require__.g.window;
function loadStyles() {
...
function handleWebpageConnection(tab, url) {
    return __awaiter(this, void 0, void 0, function* () {
        const tabId = tab.id;
        if (lodash_default().isNil(tabsInfo[tabId])) {
        ...
        const skipIntro = yield getIntroFeatureState();
        if (skipIntro) {
...
function tryUpdatePopup() {
    var _a;
    try {
        if ((_a = background_window.RollTogetherPopup) === null || _a === void 0 ? void 0 : _a.update) {
            background_window.RollTogetherPopup.update();
        }
    }
    catch (_b) {
...
chrome.runtime.onMessage.addListener(function ({ state, currentProgress, type }, sender) {
    var _a;
    ...
    switch (type) {
        ...
        case WebpageMessageTypes.LOCAL_UPDATE:
            (_a = tabInfo === null || tabInfo === void 0 ? void 0 : tabInfo.socket) === null || _a === void 0 ? void 0 : _a.emit("update", state, currentProgress);
            break;
        default:
...
function sendConnectionRequestToWebpage(tab) {
    ...
    if (tabInfo === null || tabInfo === void 0 ? void 0 : tabInfo.socket) {
...
function connectWebsocket(tabId, videoProgress, videoState, urlRoomId) {
    ...
    tabInfo.socket = esm_lookup(serverUrl, { query });
...
function getSkipIntroMarks(url) {
    ...
    xhttp.onreadystatechange = function () {
        ...
        const marks = JSON.parse(this.responseText);
...
background_window.RollTogetherBackground = {
    createRoom: sendConnectionRequestToWebpage,
    disconnectRoom: disconnectWebsocket,
    getRoomId: (tabId) => { var _a; return (_a = tabsInfo === null || tabsInfo === void 0 ? void 0 : tabsInfo[tabId]) === null || _a === void 0 ? void 0 : _a.roomId; },
};
background_window.RollTogetherPopup = {};
log("Initialized");
