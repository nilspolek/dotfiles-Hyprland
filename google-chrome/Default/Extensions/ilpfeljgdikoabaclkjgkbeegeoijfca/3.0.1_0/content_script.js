...
// UNUSED EXPORTS: runContentScript
...
;// CONCATENATED MODULE: ./src/content_script.ts


const ignoreNext = {};
let player = undefined;
let lastFrameProgress = undefined;
let beginIntro = undefined;
let endIntro = undefined;
let skipButton = undefined;
let currentSkipButtonState = undefined;
var skipButtonStates;
(function (skipButtonStates) {
    skipButtonStates["CONSTANT"] = "constant";
    skipButtonStates["HOVER"] = "hover";
    skipButtonStates["HIDDEN"] = "hidden";
})(skipButtonStates || (skipButtonStates = {}));
;
...
function getSkipButtonState(currentProgress) {
    if (lodash_default().isUndefined(beginIntro) || lodash_default().isUndefined(endIntro)) {
...
function setSkipButtonState(currentProgress) {
    ...
    if (state === currentSkipButtonState)
        return;
...
function createSkipButton() {
    ...
    if (videoContainer) {
        ...
        if (document.getElementById("skipButton") == null) {
            ...
            skipButton.onclick = () => triggerAction(Actions.TIME_UPDATE, endIntro);
...
function triggerAction(action, progress) {
    if (lodash_default().isNil(player)) {
...
function sendRoomConnectionMessage() {
    ...
    chrome.runtime.sendMessage({ state, currentProgress, type });
}
...
function handleBackgroundMessage(backgroundMessage) {
